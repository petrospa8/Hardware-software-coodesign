...
class top : public sc_module
{
	...
	{
		int i;
		// ahora mismo estos nombres de archivo est�n vacios. Posteriormente se pondr�n los archivos de c�digo m�quina y de datos internos
		char *codigos[] = {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""};
		char *datos[] = {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""};
		...
		for(i=0; i<=Nproc; ++i){	// una iteraci�n m�s que el n�mero de procesadores
